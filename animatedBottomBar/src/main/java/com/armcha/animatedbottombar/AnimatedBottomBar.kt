...
class AnimatedBottomBar(context: Context, attrs: AttributeSet) : FrameLayout(context, attrs) {
    ...
    init {
        ...
        repeat(3) {
            ...
            val fabParams =
                LayoutParams(fabRadius, fabRadius, Gravity.BOTTOM or Gravity.CENTER_HORIZONTAL)
        ...
        val params =
            LayoutParams(LayoutParams.MATCH_PARENT, bottomBarHeight.toInt(), Gravity.BOTTOM)
        addView(bottomBar, params)
        bottomBar.elevation = 11f
        bottomBar.translationZ = 11f
        val items = mutableListOf<BottomItem>()
        items+=BottomItem(R.drawable.bell_outline)
        items+=BottomItem(R.drawable.bell_outline)
        items+=BottomItem(R.drawable.bell_outline)
        items+=BottomItem(R.drawable.bell_outline)
        ...
        bottomBar.scaleX = 1.03f
        bottomBar.scaleY = 1.03f
